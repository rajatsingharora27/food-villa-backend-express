module.exports={
  ...
  EMPTY_PRODUCT_NAME_0001:"ER0001::Critical,productName cannot be empty.",
    ...
    PRODUCT_ALREADY_IN_DATABASE_0005:"ER0005::Critical,product ( ",
    PRODUCT_ALREADY_IN_DATABASE_0005_1:") Already present in the database",
    INVALID_EMAIL_FORMAT_0006_1:"ER0006::Critical,The entered email id ( ",
    INVALID_EMAIL_FORMAT_0006_2:") is in incorrect format ",
    USER_ALREADY_EXIST_0007_1:"ER0007::Critical,The user with email ID (",
    ...
    USER_NOT_FOUND_0010_1:"ER0010::Critical, User (",
    USER_NOT_FOUND_0010_2:") not present with us",
    USER_INCORRECT_PASSWORD:"ER0011::Critical, incorrect Password"
